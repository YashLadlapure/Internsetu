  ...
  if (!profileData || !profileData.profile) {
    return (
      <div className="flex items-center justify-center min-h-[80vh]">
        <p className="text-gray-500 animate-pulse font-medium text-lg">Loading Recruiter Profile...</p>
      </div>
    )
  }
  ...
  return (
    <div className="w-full mx-auto px-4 lg:px-8 py-10 ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:col-span-3 space-y-4">{/** Reserved for future recruiter widgets */}</div>
      </div>
    </div>
  )
}
