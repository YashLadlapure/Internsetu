...
import { updateEmployeeId, updateDesignation, updatePhoneNumber } from "@/lib/features/profile/tpoProfileSlice"
...
const AdminDetails = ({ employeeId, designation, phoneNumber, department }: AdminDetailsProps) => {
  ...
  const handleSave = async () => {
    try {
      const res = await callBackend("/college-admin/profile/identity", "PUT", formData)
      if (!res.success) {
